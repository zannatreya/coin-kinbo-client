        ...
        <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 md:grid-cols-4">
            ...
            <div className="sm:col-span-2">
              <Link to="/coins">
                <p className="logo">
                  Coin<span className="text-primary-focus">Kinbo</span>
                </p>
              </Link>
              <div className="mt-6 lg:max-w-sm opacity-70 font-light">
                <p className="text-sm">
                  CoinKinbo is a coin seller platform, Successfully running
                  business from 2020.
                </p>
                <p className="mt-4 text-sm">
                  In this cutting edge technology modern people's first choice
                  is CoinKinbo.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex">
                ...
                <a
                  href="https://www.google.com/maps/place/Dhaka/@23.7808632,90.2544658,11z/data=!3m1!4b1!4m6!3m5!1s0x3755b8b087026b81:0x8fa563bbdd5904c2!8m2!3d23.810332!4d90.4125181!16zL20vMGZuYjQ?entry=ttu"
                  target="_blank"
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-gray-500">
                Let's get connected with Social Media. We always share our
                updated collection there.
              </p>
            </div>
          </div>
          <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
            <p className="text-sm text-gray-600">
              © Copyright 2023 CoinKinbo. All rights reserved.
            </p>
